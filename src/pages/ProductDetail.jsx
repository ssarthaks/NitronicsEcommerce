...
const ProductDetail = () => {
  ...
  return (
    <div className="mx-auto py-12 min-h-[80vh] flex justify-center bg-nitro-black">
      <div className="flex flex-col md:flex-row justify-center items-center self-center container">
        <motion.div
        ...
        >
          ...
          >
            <img src={mainImage} alt={product.name} className="w-full h-full object-fill" />
          </motion.div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <p className="font-light text-lg text-nitro-gray-300">Category: {product.category}</p>
          {product.subCategory && (
            <p className="font-light text-lg mb-4 text-nitro-gray-300">Subcategory: {product.subCategory}</p>
          )}
          <p className="text-base mb-4 text-nitro-gray-300">{product.description}</p>
          <p className="text-lg font-bold mb-4 text-nitro-accent">Price: Nrs. {product.price}</p>
